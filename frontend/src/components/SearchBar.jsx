// SearchBar.jsx (FINAL MODIFIED VERSION - Cleaned and Robust)
...
const SearchBar = () => {
    ...
    // Removed: [visible, setVisible] state and location logic
    ...
    return (
        // Wrapper for the entire search component (fixed width and centered)
        <div className='w-full bg-gray-50 py-4 border-b border-gray-200 z-40 relative'>
            ...
            <div className='flex items-center justify-center max-w-4xl mx-auto px-4'>
                ...
                <img 
                    onClick={() => {
                        setShowSearch(false); 
                        setSearch(''); // Optional: Clear search term when closing
                    }} 
