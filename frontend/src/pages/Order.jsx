              ...
              <div key={index} className='border-t border-b py-8 text-gray-900 flex flex-col md:flex-row md:items-center md:justify-between gap-4'>
                <div className='flex items-start gap-6 text-sm'>
                        ...
                        <div>
                            ...
                            <p className='mt-2'>Date: <span className='text-gray-700'>25/05/2023</span></p>
                        </div>
                  </div>
                <div className='md:w-1/2 flex justify-between'>
                    ...
                    <button className='py-2 px-4 rounded-xl border text-sm md:text-base font-medium text-black'>Track Order</button>
